...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT u.id, u.nome, u.sobrenome, u.email, u.tipo_usuario, u.id_escola, e.id as idescola, e.nome_escola
        FROM usuario AS u JOIN escola AS e ON u.id_escola = e.id
